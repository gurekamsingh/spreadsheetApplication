    ...
    try:
        ...
        for client in socketio.server.eio.clients:
            ...
            if username:
                ...
                socketio.emit('queue_update', {'position': position}, room=client.get('sid'))
...
def write_data():
    ...
    try:
        ...
        required_fields = ['date', 'invoice_number', 'customer_name', 'location', 
                         'product_name', 'category', 'volume_sold', 'unit']
...
def handle_write_access_request(data):
    ...
    try:
        ...
        if current_lock:
            ...
            return {'success': False, 'message': f'Write access is currently held by another user. You are #{queue_position} in queue'}
...
def handle_write_access_release(data):
    ...
    try:
        ...
        if next_user:
            ...
            broadcast_update()
            return {'success': True, 'message': f'Write access released and granted to {next_user}'}
